...
<html>
	<head>
		...
		<title><spring:message code="LAB0104" /></title>
                ...
                <div id="content">  
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
						...
						<h2 class="campaign_ttl"><spring:message code="LAB0104" /></h2>
						<br />
						<%-- <p align="center">
						...
						<form name="dataForm" id="dataForm" action="menuprodoption/shop/createprodoption" method="post">
							...
							<div class="shopDataForm" style="width:100%;">
								<table id="tb" border="0" cellspacing="1" cellpadding="1"
									...
									<tr>
										...
										<td class="fillembg"><input type="text" name="prodOptionName" id="prodOptionName" size="20" maxlength="30" id="dataForm_prodOption_name" class="textOrangeFom"></input>
							...
							<div class="shopDataForm" style="width:100%;">
								<table id="list">
									...
									<tr>
										<th class="fillembg" id="addItem"></th>
									</tr>
								</table>
							</div>
