		...
		<script type="text/javascript">
			...
			function delShopLogo() {
				 if (confirm('<spring:message code="LAB1005"/>')) {
					 ...
					 $.ajax({
			   			type: "POST",
			   			url: 'shopintropic/shop/shoplogodel',
			   			data: '',
			   			dataType: 'json',
			   			...
			   			success: function(data, textStatus){
			   				if(textStatus=='success'){
			   					alert(data.msg);
			   					location.href='<c:url value="/shopintropic/shop/shoplogo" />';
			   				} else {
                 ...
                 <div id="cont_right">  
                   ...
                   <div class="serviceTermForm">
						...
						<h2 class="campaign_ttl">
							<spring:message code="ShopLogo" />
						</h2>
						<div align="center">
							<h2>
								<font color="#6633FF"><spring:message code="logoPic"/></font>
							</h2>
						</div>
						<br /> <br />
								...
								<table id="tb" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										<td>
											...
											<div id="uploPath">
												...
												<img src="${path}" />
												<button type="button" id="delShopLogo" class="deleteBtn"></button>
									...
									<tr>
										<td class="embg">
											...
											<form method="post" action="shopintropic/shop/shoplogoup" enctype="multipart/form-data" onsubmit="return checkThing();"> 
											<br/> <br/> 
											<spring:message code="LAB1001"/>
											<input type="file" id="shopLogoFile" name="image" size="50" onchange="chkfile(this);" /> <br/>
												<br /> <spring:message code="LAB1002"/> <br/>
